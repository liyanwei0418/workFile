...
<head lang="en">
    ...
    <style>
        * {
        ...
        .adddele-time input[name='sEndTimeView']{
            margin-left: 130px;
        }
        .adddele-time .btn-ad{
            margin-left: 130px;
...
<script>
    ...
    function addScreenOffTime(addButton) {
        var html = "<div class=\"jeitem adddele-time\"><div class=\"jeinpbox\"><div class=\"jeinpbox\"><input type=\"text\" class=\"jeinput\" placeholder=\"\" onfocus=\"timeShow(this)\" readonly name=\"sStartTimeView\"></div></div><div class=\"jeinpbox\"><div class=\"jeinpbox\"><input type=\"text\" class=\"jeinput\" placeholder=\"\" onfocus=\"timeShow(this)\" readonly name=\"sEndTimeView\"></div></div><button onclick=\"addScreenOffTime(this)\" class='btn-ad'>+</button> <button onclick=\"delScreenOffTime(this)\" class='btn-de'>-</button></div>";
