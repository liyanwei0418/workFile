...
<body>
<div>
    <form action="" method="post" class="courseClass">
        <ul id="ClassCardUl">
            ...
            <p id="qt_all" class="" style="display: none;">其他<input type="checkbox" ${disabled} value="" style='margin-left: 5px;' class="qt_check_all"><span class="school-type">全选</span></p>
